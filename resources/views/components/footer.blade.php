<footer class="bg-stone-900 text-white pt-16">
    <div class="max-w-screen-xl px-4 sm:px-6 md:px-8 lg:px-12 mx-auto">
        ...
        <div class="border-t border-stone-800 mt-16 py-10 text-center text-gray-400">
            <p>&copy; 2025 Khdamly. All rights reserved.</p>
        </div>
    </div>
</footer>