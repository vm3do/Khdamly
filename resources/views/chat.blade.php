        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-2xl p-6 border-2 border-gold/20 shadow-lg shadow-gold/5">
                    ...
                    <div class="space-y-4">
                        <form action="{{ route('request.show.chat', $request->id) }}" method="GET">
                    ...
                    <div class="flex-1 p-6 overflow-y-auto">
                        <div class="h-full flex items-center justify-center">
                            <div class="text-center">
                                <svg class="w-16 h-16 text-gold/50 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                </svg>
                                <h3 class="font-playfair text-xl text-luxury-green mb-2">Select a Chat</h3>
