                ...
                <div class="rounded-md shadow-sm space-y-4">
                    ...
                    <div>
                        ...
                        <select id="city" name="city" value="{{old('city')}}" required 
                            ...
                            <option value="jeddah">Rabat</option>
                            <option value="dammam">Oujda</option>
                        </select>
                    </div>
                    ...
                    <div id="artisan-fields" class="hidden space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gold/20 border-dashed rounded-xl">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gold" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <div class="flex text-sm text-gray-600">
                                        <label for="portfolio" class="relative cursor-pointer bg-white rounded-md font-medium text-luxury-green hover:text-light-green focus-within:outline-none">
                                            <span>Upload files</span>
                                            <input id="portfolio" name="portfolio[]" type="file" multiple accept="image/*" 
                                                class="sr-only" min="3" max="5">
                                        </label>
