            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-2xl p-6 border-2 border-gold/20 shadow-lg shadow-gold/5">
                    ...
                    <div class="relative mb-6">
                        ...
                        <svg class="w-5 h-5 text-gold absolute right-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-4">
                        <!-- Chat 1 -->
                        <div class="flex items-center gap-4 p-4 rounded-xl hover:bg-cream/50 cursor-pointer transition duration-300">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    <h3 class="font-medium text-gray-800">Ali Br</h3>
                                    <span class="text-sm text-gray-500">2h ago</span>
                                </div>
                                <p class="text-sm text-gray-600 truncate">Thank you for your interest in my pottery work...</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 p-4 rounded-xl hover:bg-cream/50 cursor-pointer transition duration-300">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-600 truncate">I've completed the textile design you requested...</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border-2 border-gold/20 shadow-lg shadow-gold/5 h-[600px] flex flex-col">
                    ...
                    <div class="flex-1 p-6 overflow-y-auto space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <div class="bg-cream rounded-2xl p-4">
                                    <p class="text-gray-800">Hello! Thank you for your interest in my pottery work. I'd be happy to discuss your requirements.</p>
                                </div>
                        ...
                        <div class="flex items-start gap-4 justify-end">
                            <div class="flex-1 max-w-[70%]">
                                <div class="bg-luxury-green text-white rounded-2xl p-4">
                                    <p class="text-white">I'm interested in commissioning a custom vase with traditional Moroccan patterns. Could you share some examples of your previous work?</p>
                                </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <div class="bg-cream rounded-2xl p-4">
                                    <p class="text-gray-800">Here are some examples of my recent work. I specialize in traditional patterns with a modern twist...</p>
                    ...
                    <div class="p-6 border-t border-gold/20">
                        <div class="flex items-center gap-4">
                            <div class="relative flex-1">
                                ...
                                <button class="absolute left-3 top-1/2 -translate-y-1/2 p-2 text-gold hover:text-luxury-green transition duration-300">
